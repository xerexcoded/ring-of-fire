...
VALUES
  ('gvp', 'Global Volcanism Program', 'Smithsonian Institution',
   ...
   '5.3.6', '2026-05-26T00:00:00Z', now(), 1215, 41, 'approved',
   '{"scope":"GVP Holocene catalog with reviewed Smithsonian Pacific Ring of Fire membership","catalogFixture":"gvp-holocene-5.3.6.tsv","membershipFixture":"pinned-prof-5.3.6","profCount":688,"educationalUse":true}'::jsonb),
