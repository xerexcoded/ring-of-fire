...
export function PromptInputTextarea({
  ...
  useLayoutEffect(() => {
    ...
    // Prompt Kit intentionally recalculates when the controlled value changes.
...
export function PromptInputAction({ tooltip, children, className, side = "top", ...props }: PromptInputActionProps) {
