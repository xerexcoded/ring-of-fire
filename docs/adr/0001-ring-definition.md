...
- Install the complete official 1,215-row Holocene catalog as the comparison
  universe and pin its sorted volcano-number set independently. For v5.3.6 its
  SHA-256 is
  `e23e13216b7af4f682c0ae04ff153c0744b20e8bf204b746a916d1f08281e690`.
...
reproducible after a source revision. The full catalog also lets a visitor test
a counterfactual rule without silently limiting the candidates to the reviewed
set. Queries are slightly more verbose and a source update requires human
review, but the uncertainty becomes inspectable rather than hidden.
